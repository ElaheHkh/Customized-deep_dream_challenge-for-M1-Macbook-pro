...
Original file is located at
    https://colab.research.google.com/drive/1hScl6DZjOmhMYDMRe2YPny66ezt5ouPv
"""
...
def main():
  #Step 1- download google's pretrsined neural network
  ...
  t_input= tf.compat.v1.placeholder(np.float32,name='input') #define input tensor
  imagenet_mean=11.7
